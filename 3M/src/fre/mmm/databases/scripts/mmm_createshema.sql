...
CREATE TABLE T_USERS ( 
	ID_USER              integer GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL,
...
CREATE TABLE T_ACTIONS ( 
	ID_ACTION            integer GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL,
...
CREATE TABLE T_CONGES ( 
	ID_CONGES            integer GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL,
	ID_USER              integer   NOT NULL,
	DATE_BEGIN           date   ,
	DATE_END             date   ,
...
CREATE TABLE T_PROJET ( 
	ID_PROJET            integer GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL,
	ID_USER              integer   NOT NULL,
...
CREATE TABLE T_LIVRABLE ( 
	ID_LIVRABLE          integer GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL,
	ID_PROJET            integer   NOT NULL,
